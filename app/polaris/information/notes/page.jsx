        ...
        <div className='mainsection'>
            ...
            <div className='infonote note'>
                ...
                <p className='notetext'>
                    This is an information note, its purpose is to provide you with information that may not be obvious
                    to distinguish from the docs, or newly found out content. This note may also say when something is
                    under development, or general notes about something.
                </p>
            </div>
            ...
            <div className='minornote note'>
                ...
                <p className='notetext'>
                    This is a minor warning note/caution note. This notes purpose is to give warn you about very
                    unlikely issues or just to let you acknowledge something of minor importance.
                </p>
            </div>
            <div className='correctnote note'>
                <img src='https://cdn.polarlab.app/src/docs/img/correct.png' alt='alt' className='noteicon' />
                <p className='notetext'>
                    This is a correct/check note. This note provides helpful tips to assist you, or describes a specific
                    method to achieve optimal overall results. This note can also congratulate you on your amazing work
                    with configuration!
                </p>
            </div>
